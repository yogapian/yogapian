          ...
          return (
            <div key={i} onClick={() => !unselectable && onSelect(ds)}
              ...
              <div style={{display:"flex",flexDirection:"row",flexWrap:"wrap",alignItems:"center",justifyContent:"center",gap:3,marginTop:0,minHeight:10}}>
                {isToday    && <span style={{fontSize:8,color:"#c4d7bd",lineHeight:1,fontWeight:700}}>오늘</span>}
                ...
                {isClosure && <span style={{fontSize:8,color:"#a83030",background:"#fde8e8",borderRadius:3,padding:"1px 3px",fontWeight:700,lineHeight:1,display:"flex",alignItems:"center",justifyContent:"center"}}>휴강</span>}{/* ← 휴강 뱃지 텍스트/배경색 */}
