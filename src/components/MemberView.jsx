...
export default function MemberView({member,bookings,setBookings,setMembers,specialSchedules,closures,notices,setNotices,scheduleTemplate,onBookingNotif,onRefresh,onLogout}){
  ...
  // 활성 기수 시작일 기준 홀딩 일수 — 미래 기수 pre-register 시 m.startDate 오류 방지
  const holdExt=isPendingPeriod?0:totalHoldingCalendarDays(m,_ap?.startDate||m.startDate);
              ...
              <div style={S.dateRow}>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:2}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap",overflow:"hidden"}}>
                    ...
                    {!isPendingPeriod&&closureExt>0&&<span style={{fontSize:9,background:"#f0ede8",color:"#8a7e70",borderRadius:4,padding:"1px 4px",fontWeight:600}}>휴강+{closureExt}일</span>}
