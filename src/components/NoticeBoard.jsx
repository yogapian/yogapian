...
export default function NoticeBoard({notices,member}){
  ...
  return(
    <div style={{marginBottom:8}}>
      {visible.map(n=>(
        <div key={n.id} style={{background:n.pinned?"#f6efbf8d":"#fff",border:`1px solid ${n.pinned?"#f4ca3d":"#be8e35"}`,borderRadius:12,padding:"8px 14px",marginBottom:8,cursor:"pointer"}} onClick={()=>setExpanded(expanded===n.id?null:n.id)}>
